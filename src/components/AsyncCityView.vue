<template>
    <div class="flex flex-col flex-1 items-center">
        ...
        <div v-if="route.query.preview" class="text-white p-4 bg-weather-secondary w-full text-center">
            <p>You are currently prviewning the city, click the "+" icon to start tracking this city</p>
        </div>
        <!-- Weather Overview -->
        ...
        <div class="max-w-screen-md w-full py-12">
            <div class="mx-8 text-white">
                <h2 class="mb-8">Hourly Weather</h2>
                <div class="flex gap-10 overflow-x-auto">
                    <div v-for="hourData in weatherData.hourly" :key="weatherData.dt"
        ...
        <div class="max-w-screen-md w-full py-12">
            <div class="mx-8 text-white">
                ...
                <div v-for="day in weatherData.daily" :key="day.dt" class="flex items-center">
                    ...
                    <duv class="flex gap-2 flex-1 justify-end">
...
const getWeatherData = async () => {
    try {
        const weatherData = await axios.get(`https://api.openweathermap.org/data/3.0/onecall?lat=${route.query.lat}&lon=${route.query.lng}&exclude={part}&appid=214f2db52db53ac401a08723ccaad17e&units=imperial`)
